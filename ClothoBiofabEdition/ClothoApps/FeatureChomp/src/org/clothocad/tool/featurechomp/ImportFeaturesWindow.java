...
public class ImportFeaturesWindow extends javax.swing.JFrame {
    ...
    public ImportFeaturesWindow(String type, String s, FeatureChompController fcc, ArrayList<String> inputLines) {
        initComponents();
        _type = type;
        _sequence = s;
                ...
                if (_type.equals("genbank")) {
                    new SwingWorker() {
                        ...
                        protected Object doInBackground() throws Exception {
                            _controller.parseForGenbankFeatures(_sequence, (ObjLink) collectionComboBox.getSelectedItem(), parseTarget);
                            return null;
                        }
                    }.execute();
                    ...
                    new SwingWorker() {
                        ...
                        @Override
                        protected Object doInBackground() throws Exception {
                            _controller.parseForApEFeatures((ObjLink) collectionComboBox.getSelectedItem(), parseTarget);
                            return null;
                        }
                    }.execute();
                }
